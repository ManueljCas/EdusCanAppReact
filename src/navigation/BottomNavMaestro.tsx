...
import styles from './NavMaestro';

const icons = ['home', 'calendar-plus', 'plus', 'cog'];

const BottomNavMaestro: React.FC<BottomTabBarProps> = ({ state, descriptors, navigation }) => {
...
export default BottomNavMaestro;
